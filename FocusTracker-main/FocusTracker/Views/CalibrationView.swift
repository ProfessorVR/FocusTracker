    ...
    private func instructionsView(screenSize: CGSize) -> some View {
        VStack(spacing: 28) {
            ...
            VStack(spacing: 12) {
                ...
                Text("You will see 9 dots appear on screen. Look directly at each dot and hold your gaze steady until it moves to the next position.")
                    .font(.subheadline)
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Point \(viewModel.currentPointIndex + 1) of \(viewModel.totalPoints)")
                        .font(.subheadline)
