...
final class CalibrationEngine: ObservableObject {
    ...
    func computeCalibration() -> CalibrationResult {
        ...
        // Step 4: Compute accuracy as average Euclidean error after transform.
        ...
        // Step 5: Build CalibrationPoint records for provenance.
    ...
    /// (scale + rotation + offset) to the measured points.
